...
require "./bibliotecas/PHPMailer/SMTP.ph";
...
try {
	...
	$mail->Username = 'Inserir o seu gmail.';                 // SMTP username
	$mail->Password = 'Inserir a sua senha.';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;      
	$mail -> CharSet = "UTF-8";                               // TCP port to connect to

	//Recipients
	$mail->setFrom('Seu gmail', 'Seu nome');
